...
namespace Core
{
    public sealed class FactionMemberParallelInfoUpdater: MonoBehaviour, ITickable
    {
        ...
        public void Tick()
        {
            AutoAttackEvaluator.FactionMembersInfo.AddOrUpdate(
                gameObject, new AutoAttackEvaluator.FactionMemberParallelInfo(transform.position, _factionMember.FactionId), (go, value) =>
                {
